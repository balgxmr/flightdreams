...
<html lang="en">
  ...
  <body>
      ...
      <div class="container py-3">
        ...
        <form method="POST" action="../config/routes.php?controller=viajes&action=reservar">
          ...
          <div class="row g-3 mb-3">
            ...
            <!-- autobus -->
            <div class="col-md-4">
              <label for="tipo_autobus" class="form-label">Tipo de autobús</label>
              <select name="tipo_autobus" id="tipo_autobus" class="form-select" required>
    ...
    <section class="mainContainer">
        ...
        <h3 class="mainContainer--subtitle pb-5">Te recomendamos viajes en Autobuses</h3>
