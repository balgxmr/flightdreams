...
<html lang="en">
  ...
  <body>
      ...
      <div class="container py-3">
        ...
        <form method="POST" action="../config/routes.php?controller=viajes&action=reservar">
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-3">
              <label for="destino_origen" class="form-label">Aeropuerto de origen</label>
              <input 
                type="text" 
                name="destino_origen" 
                id="destino_origen" 
            ...
            <!-- Clase del vuelo -->
            <div class="col-md-3">
              <label for="clase_vuelo" class="form-label">Clase del vuelo</label>
              <select name="clase_vuelo" id="clase_vuelo" class="form-select">
    ...
    <section class="mainContainer">
        ...
        <h3 class="mainContainer--subtitle pb-5">Te recomendamos viajes en Vuelos</h3>
