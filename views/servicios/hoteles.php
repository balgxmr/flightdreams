...
<html lang="en">
  ...
  <body>
    ...
    <section class="mainContainer formsContainer">
      <div class="container py-3">
        ...
        <form method="POST" action="../config/routes.php?controller=viajes&action=reservar">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
              ...
              <input 
                ...
                required 
                maxlength="65" 
                placeholder="Ej. Hotel Luxor 400">
            </div>
            
            <!-- Tipo de habitación -->
            <div class="col-md-4">
              <label for="tipo_habitacion" class="form-label">Tipo de habitación</label>
              <select id="tipo_habitacion" class="form-select" required>
          ...
          <input type="hidden" name="servicio" value="hoteles" />
    ...
    <section class="mainContainer">
        ...
        <h3 class="mainContainer--subtitle pb-5">Te recomendamos viajes a Hoteles</h3>
