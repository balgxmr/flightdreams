...
<html lang="en">
  ...
  <body>
          ...
          <div class="row g-3 mb-3">            
            ...
            <div class="col-md-4">
              ...
              <input 
                ...
                required 
                maxlength="65"
                placeholder="Ej. Estación Las Nevadas">
            </div>
            ...
            <!-- Destino -->
            <div class="col-md-4">
              <label for="clase_tren" class="form-label">Clase del tren</label>
              <select name="clase_tren" id="clase_tren" class="form-select">
    ...
    <section class="mainContainer">
        ...
        <h3 class="mainContainer--subtitle pb-5">Te recomendamos viajes en Trenes</h3>
